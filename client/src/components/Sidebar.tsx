  ...
  return (
    <div className="sidebar">
      ...
      <nav className="sidebar-nav">
        ...
        {/* <button
          className={`sidebar-button ${activeView === 'calendar' ? 'active' : ''}`}
        ...
        <button
          className={`sidebar-button ${activeView === 'chatbot' ? 'active' : ''}`}
        ...
        <button
          className={`sidebar-button ${activeView === 'teamchat' ? 'active' : ''}`}
          onClick={() => onViewChange('teamchat')}
        >
          <svg
            width="20"
            height="20"
