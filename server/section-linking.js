...
export const ENTITY_CORE_FIELDS = {
  client: ["company_name", "field", "service", "location", "region", "info", "category", "budget", "first_name", "last_name", "email", "phone", "website", "field_specialization", "company_structure", "region_structure", "tier", "location_geo"],
  partner: ["company_name", "field", "location", "region", "info", "category", "first_name", "last_name", "email", "phone", "website", "field_specialization", "company_structure", "region_structure", "tier", "location_geo"],
  tiper: ["company_name", "field", "location", "region", "info", "category", "first_name", "last_name", "email", "phone", "website", "field_specialization", "company_structure", "region_structure", "tier", "location_geo"],
};
