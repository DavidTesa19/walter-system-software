...
export function createPartnerEntity(db, data) {
  ...
  const entity = {
    ...
    field_specialization: data.field_specialization || null,
    company_structure: data.company_structure || null,
    region_structure: data.region_structure || null,
    tier: data.tier || null,
    location_geo: data.location_geo || null,
    info: data.info || null,
